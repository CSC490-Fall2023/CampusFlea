...
export class EntityProcessor {
    ...
    process() {
        ...
        return createSourceFile([...imports.toCode(), ...statements, ...exports.toCode()], this.#outputPathManager.createRelativePath(this.#path));
    }
    #processClass(schema) {
        ...
        return ts.factory.createInterfaceDeclaration(undefined, this.#id, undefined, undefined, this.#processTypeElements(schema));
    }
    ...
    #processExtendedClass(schema) {
        ...
        if (isComposedSchema(schema)) {
            ...
            return (declaration &&
                ts.factory.updateInterfaceDeclaration(declaration, declaration.modifiers, declaration.name, undefined, [
