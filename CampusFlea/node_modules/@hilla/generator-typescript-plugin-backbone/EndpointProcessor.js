...
export default class EndpointProcessor {
    ...
    async process() {
        ...
        return createSourceFile([...imports.toCode(), ...statements, ...exports.toCode()], this.#createdFilePaths.createRelativePath(this.#name));
    }
    async #processMethod(method, pathItem) {
        ...
        return (await Promise.all(Object.values(OpenAPIV3.HttpMethods)
            ...
            .map(async (httpMethod) => EndpointMethodOperationProcessor.createProcessor(httpMethod, this.#name, method, pathItem[httpMethod], this.#dependencies, this.#owner)?.process(this.#outputDir)))).filter(Boolean);
    }
}
