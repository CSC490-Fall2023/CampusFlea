...
class BackbonePlugin extends Plugin {
    ...
    async #processEndpoints(storage) {
        ...
        const processors = await Promise.all([...endpoints.entries()].map(async ([endpointName, methods]) => EndpointProcessor.create(endpointName, this, methods, storage.outputDir)));
