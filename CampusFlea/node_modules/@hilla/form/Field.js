...
export class AbstractFieldStrategy {
     ...
     * @private
     */
    _validityFallback = defaultValidity;
...
export class VaadinFieldStrategy extends AbstractFieldStrategy {
    ...
    constructor(element, model) {
        ...
        element.addEventListener('validated', this._overrideVaadinInvalidChange.bind(this));
    }
    set required(value) {
    ...
    _overrideVaadinInvalidChange(e) {
