...
export type ValidationCallback<T> = (value: T, binder: Binder<unknown, AbstractModel<unknown>>) => Promise<ValidationResult | boolean | readonly ValidationResult[]> | ValidationResult | boolean | readonly ValidationResult[];
