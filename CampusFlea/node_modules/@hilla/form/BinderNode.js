...
export class BinderNode {
    ...
    async updateValidation() {
        if (this[_visited]) {
            ...
            await Promise.all([...this.getChildBinderNodes()].map(async (childBinderNode) => childBinderNode.updateValidation()));
        }
    }
    update(_) {
        if (this.parent) {
    ...
    *getChildBinderNodes() {
    ...
    runOwnValidators() {
        if (this[_validity] && !this[_validity].valid) {
            ...
            return [...this[_validators], this.validityStateValidator].map((validator) => this.binder.requestValidation(this.model, validator));
        }
