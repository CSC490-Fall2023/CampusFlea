...
export declare class ArrayModel<T, M extends AbstractModel<T>> extends AbstractModel<readonly T[]> {
    ...
    constructor(parent: ModelParent<readonly T[]>, key: keyof any, optional: boolean, ItemModel: ModelConstructor<T, M>, itemModelArgs: ModelVariableArguments<typeof ItemModel>, ...validators: ReadonlyArray<Validator<readonly T[]>>);
    /**
